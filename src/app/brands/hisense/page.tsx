...
export const metadata: Metadata = {
  title: 'Hisense Refrigerator Repair in Houston, TX | Fast Service',
  description:
    'Expert Hisense refrigerator repair in Houston, TX. French door, side-by-side, and bottom freezer models. Same-day service. Call (346) 512-3688.',
}
...
const popularModels = ['RQ56WC4SAB', 'RS26F3CDBHB', 'RQ56WC4SAW', 'RB15N6AWE', 'RS694N4BCE']

export default function HisenseBrandPage() {
  const cases = repairCases.filter(rc => rc.brandSlug === 'hisense')
    ...
    <>
      ...
      <section className="bg-brand-gray py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-sm text-gray-500 mb-2">
            <Link href="/brands" className="hover:text-brand-blue">Brands</Link> / Hisense
          </div>
          <h1 className="font-display text-4xl md:text-5xl font-extrabold text-brand-dark mb-4">
            Hisense Refrigerator Repair<br className="hidden md:block" /> in Houston
          </h1>
          <p className="text-gray-600 text-lg max-w-2xl mb-8">
            Hisense refrigerators offer modern features at competitive prices. Our technicians diagnose
            and repair all Hisense models in Houston with fast turnaround and quality parts.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid md:grid-cols-2 gap-12">
          ...
          <div>
            <h2 className="font-display text-2xl font-bold text-brand-dark mb-6">
              Common Hisense Problems We Fix
            </h2>
          ...
          <div>
            <h2 className="font-display text-2xl font-bold text-brand-dark mb-6">
              Popular Hisense Models We Service
            </h2>
            ...
            <div className="mt-8 bg-brand-gray rounded-2xl p-6">
              ...
              <p className="text-gray-600 text-sm mb-4">
                We service all Hisense refrigerator models. Call us to confirm availability.
              </p>
      ...
      {cases.length > 0 && (
        <section className="py-16 bg-brand-gray">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <h2 className="section-title mb-8">Real Hisense Repair Cases in Houston</h2>
      ...
      <CTABanner
        title="Need Hisense Refrigerator Repair?"
