...
export const metadata: Metadata = {
  title: 'Kenmore Refrigerator Repair in Houston, TX | Trusted Technicians',
  description:
    'Expert Kenmore refrigerator repair in Houston, TX. All Kenmore models including Elite series. Same-day service available. Call (346) 512-3688.',
}
...
const popularModels = ['253.60522010', '253.70343410', '253.79182992', '795.72503311', '106.58522890']

export default function KenmoreBrandPage() {
  const cases = repairCases.filter(rc => rc.brandSlug === 'kenmore')
    ...
    <>
      ...
      <section className="bg-brand-gray py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-sm text-gray-500 mb-2">
            <Link href="/brands" className="hover:text-brand-blue">Brands</Link> / Kenmore
          </div>
          <h1 className="font-display text-4xl md:text-5xl font-extrabold text-brand-dark mb-4">
            Kenmore Refrigerator Repair<br className="hidden md:block" /> in Houston
          </h1>
          <p className="text-gray-600 text-lg max-w-2xl mb-8">
            Kenmore refrigerators have been trusted in American homes for generations. Our technicians
            service all Kenmore models including Elite series throughout Houston with competitive pricing.
          </p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid md:grid-cols-2 gap-12">
          ...
          <div>
            <h2 className="font-display text-2xl font-bold text-brand-dark mb-6">
              Popular Kenmore Models We Service
            </h2>
            ...
            <div className="mt-8 bg-brand-gray rounded-2xl p-6">
              ...
              <p className="text-gray-600 text-sm mb-4">
                We service all Kenmore refrigerator models. Call us to confirm availability.
              </p>
      ...
      {cases.length > 0 && (
        <section className="py-16 bg-brand-gray">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <h2 className="section-title mb-8">Real Kenmore Repair Cases in Houston</h2>
      ...
      <CTABanner
        title="Need Kenmore Refrigerator Repair?"
