...
export const metadata: Metadata = {
  title: 'Maytag Refrigerator Repair in Houston, TX | Trusted Technicians',
  description:
    'Expert Maytag refrigerator repair in Houston, TX. All models including French door and side-by-side. Same-day service. Call (346) 512-3688.',
}
...
const popularModels = ['MRT118FFFZ', 'MSS25C4MGZ', 'MFX2876DRM', 'MSS26C6MDE', 'MFI2570FEZ']

export default function MaytagBrandPage() {
  const cases = repairCases.filter(rc => rc.brandSlug === 'maytag')
    ...
    <>
      ...
      <section className="bg-brand-gray py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-sm text-gray-500 mb-2">
            <Link href="/brands" className="hover:text-brand-blue">Brands</Link> / Maytag
          </div>
          <h1 className="font-display text-4xl md:text-5xl font-extrabold text-brand-dark mb-4">
            Maytag Refrigerator Repair<br className="hidden md:block" /> in Houston
          </h1>
          <p className="text-gray-600 text-lg max-w-2xl mb-8">
            Maytag refrigerators are built tough and trusted in Houston homes for decades. Our technicians
            service all Maytag models quickly and affordably, with same-day availability in most areas.
          </p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid md:grid-cols-2 gap-12">
          ...
          <div>
            <h2 className="font-display text-2xl font-bold text-brand-dark mb-6">
              Popular Maytag Models We Service
            </h2>
            ...
            <div className="mt-8 bg-brand-gray rounded-2xl p-6">
              ...
              <p className="text-gray-600 text-sm mb-4">
                We service all Maytag refrigerator models. Call us to confirm availability.
              </p>
      ...
      {cases.length > 0 && (
        <section className="py-16 bg-brand-gray">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <h2 className="section-title mb-8">Real Maytag Repair Cases in Houston</h2>
      ...
      <CTABanner
        title="Need Maytag Refrigerator Repair?"
