...
export const metadata: Metadata = {
  title: 'Zline Refrigerator Repair in Houston, TX | Italian Design Specialists',
  description:
    'Expert Zline refrigerator repair in Houston, TX. Built-in column and French door models. Italian-designed luxury refrigerators. Call (346) 512-3688.',
}
...
const popularModels = ['RBIV-30', 'RBV-30', 'RSMIV-24', 'RBV-24', 'RBIVD-30']

export default function ZlineBrandPage() {
  const cases = repairCases.filter(rc => rc.brandSlug === 'zline')
    ...
    <>
      ...
      <section className="bg-brand-gray py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-sm text-gray-500 mb-2">
            <Link href="/brands" className="hover:text-brand-blue">Brands</Link> / Zline
          </div>
          <h1 className="font-display text-4xl md:text-5xl font-extrabold text-brand-dark mb-4">
            Zline Refrigerator Repair<br className="hidden md:block" /> in Houston
          </h1>
          <p className="text-gray-600 text-lg max-w-2xl mb-8">
            Zline refrigerators feature Italian-inspired design and professional-grade performance. Our
            technicians are experienced with Zline built-in column and French door refrigerators throughout Houston.
          </p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid md:grid-cols-2 gap-12">
          ...
          <div>
            <h2 className="font-display text-2xl font-bold text-brand-dark mb-6">
              Popular Zline Models We Service
            </h2>
            ...
            <div className="mt-8 bg-brand-gray rounded-2xl p-6">
              ...
              <p className="text-gray-600 text-sm mb-4">
                We service all Zline refrigerator models. Call us to confirm availability.
              </p>
      ...
      {cases.length > 0 && (
        <section className="py-16 bg-brand-gray">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <h2 className="section-title mb-8">Real Zline Repair Cases in Houston</h2>
      ...
      <CTABanner
        title="Need Zline Refrigerator Repair?"
