...
export const metadata: Metadata = {
  title: 'Electrolux Refrigerator Repair in Houston, TX | European Specialists',
  description:
    'Expert Electrolux refrigerator repair in Houston, TX. French door and built-in models. European engineering specialists. Call (346) 512-3688.',
}
...
const popularModels = ['EW28BS71IB', 'EW26SS65GS', 'EW23BC87HS', 'EI28BS65KS', 'EI23BC65KS']

export default function ElectroluxBrandPage() {
  const cases = repairCases.filter(rc => rc.brandSlug === 'electrolux')
    ...
    <>
      ...
      <section className="bg-brand-gray py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-sm text-gray-500 mb-2">
            <Link href="/brands" className="hover:text-brand-blue">Brands</Link> / Electrolux
          </div>
          <h1 className="font-display text-4xl md:text-5xl font-extrabold text-brand-dark mb-4">
            Electrolux Refrigerator Repair<br className="hidden md:block" /> in Houston
          </h1>
          <p className="text-gray-600 text-lg max-w-2xl mb-8">
            Electrolux refrigerators combine Scandinavian design with innovative cooling technology. Our
            technicians are experienced with Electrolux European-engineered sealed systems and advanced features.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid md:grid-cols-2 gap-12">
          ...
          <div>
            <h2 className="font-display text-2xl font-bold text-brand-dark mb-6">
              Common Electrolux Problems We Fix
            </h2>
          ...
          <div>
            <h2 className="font-display text-2xl font-bold text-brand-dark mb-6">
              Popular Electrolux Models We Service
            </h2>
            ...
            <div className="mt-8 bg-brand-gray rounded-2xl p-6">
              ...
              <p className="text-gray-600 text-sm mb-4">
                We service all Electrolux refrigerator models. Call us to confirm availability.
              </p>
      ...
      {cases.length > 0 && (
        <section className="py-16 bg-brand-gray">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <h2 className="section-title mb-8">Real Electrolux Repair Cases in Houston</h2>
      ...
      <CTABanner
        title="Need Electrolux Refrigerator Repair?"
