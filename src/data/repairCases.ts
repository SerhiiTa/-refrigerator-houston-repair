...
export const repairCases: RepairCase[] = [
  ...
  {
    slug: 'kitchenaid-kutx505ess1-ice-maker-not-producing-ice',
    brand: 'KitchenAid',
    ...
    repairPerformed: 'Disconnected the KitchenAid KUTX505ESS1 from the 115V power supply and shut off the water supply line to ensure safe working conditions.. Removed the ice maker\'s access panel and outer casing to gain full access to the internal components, including the circulation pump and water inlet valve.. Used a multimeter to verify incoming voltage at 115V and confirmed proper electrical continuity at the control board terminals.. Diagnosed the integrated water level sensor within the circulation pump as faulty — it was sending a \'bin full\' signal to the control board despite the bin being empty, preventing the water inlet valve from receiving an open command.. Disconnected the circulation pump electrical harness and water connections, then removed the defective pump assembly from the unit.. Installed a new OEM-compatible circulation pump with an integrated water level sensor, ensuring all electrical connectors and water line fittings were seated and tightened securely.. Powered the unit on temporarily to verify the new pump\'s sensor was reporting the correct water level (empty), and confirmed the control board was now issuing the open command to the water inlet valve.. Observed that water flow through the inlet valve was severely restricted — only a slow drip — confirming a secondary fault: a heavily clogged water inlet valve.. Shut down the unit again and removed the clogged water inlet valve; visually confirmed significant mineral and contaminant buildup inside the valve body. Photographic documentation showed the water inside the system was black due to contamination.. Installed a new OEM-spec water inlet valve sourced directly from the technician\'s truck stock, matching the original valve\'s flow rate and solenoid specifications for the KUTX505ESS1 model.. Flushed and drained all old, contaminated water from the system; confirmed water exiting during the flush was visibly dark before running clear, indicating successful purge of the contamination.. Reassembled all panels, reconnected the water supply line and power, and performed a full restart of the ice maker cycle. Monitored the first complete ice production cycle to confirm proper water fill, freeze, and harvest sequences before closing the case.',
    partsReplaced: [
    ...
    image: '/images/repair-kitchenaid-kutx505ess1-2.jpeg',
    photos: [
      { src: '/images/repair-kitchenaid-kutx505ess1-1.jpeg', caption: 'KitchenAid KUTX505ESS1 repair in Memorial, TX' },
      { src: '/images/repair-kitchenaid-kutx505ess1-2.jpeg', caption: 'KitchenAid KUTX505ESS1 repair in Memorial, TX' },
      { src: '/images/repair-kitchenaid-kutx505ess1-3.jpeg', caption: 'KitchenAid KUTX505ESS1 repair in Memorial, TX' },
      { src: '/images/repair-kitchenaid-kutx505ess1-4.jpeg', caption: 'KitchenAid KUTX505ESS1 repair in Memorial, TX' },
      { src: '/images/repair-kitchenaid-kutx505ess1-5.jpeg', caption: 'KitchenAid KUTX505ESS1 repair in Memorial, TX' },
    ],
    technicianSlug: 'serhii-t',
  },
  {
    slug: 'sub-zero-ec40-ec50-annual-maintenance-houston',
    brand: 'Sub-Zero',
    brandSlug: 'sub-zero',
    model: 'N/A',
    city: 'Houston',
    ...
    repairPerformed: 'Performed a full diagnostic scan of the Sub-Zero control board, confirming active fault codes EC40 and EC50 with timestamp history to assess frequency and duration of thermal events.. Powered down the unit safely and disconnected it from the outlet to allow safe access to the condenser compartment located at the base of the unit behind the toe kick grille.. Removed the toe kick grille and condenser access panel using appropriate screwdrivers, exposing the full condenser coil assembly.. Applied professional-grade active foaming condenser coil cleaner to the entire coil surface, allowing the foam to penetrate and encapsulate debris, dust, and grease buildup for the manufacturer-recommended dwell time.. Used a low-pressure air purge and soft-bristle brush to agitate loosened debris, then thoroughly rinsed the coil with controlled water application, ensuring no moisture contacted electrical components.. Dried the condenser area with compressed air and verified full coil fin exposure with no remaining obstructions visible between the coil rows.. Reinstalled the condenser access panel and toe kick grille, ensuring all fasteners were properly seated and airflow pathways were unobstructed.. Reconnected the unit to power and used a digital clamp ammeter to measure live running amperage on both compressors — fresh food compressor measured within rated spec, and freezer compressor likewise returned to normal operating current draw.. Inspected all door gaskets on both the fresh food and freezer sections using the dollar-bill drag test at multiple points around the full perimeter; confirmed gaskets were sealing adequately with no cold air leakage detected.. Cleared the EC40 and EC50 fault codes from the Sub-Zero control board memory using the diagnostic reset procedure and monitored the unit for 20 minutes post-reset to confirm no immediate code recurrence.. Verified condenser fan motor operation, checking blade rotation, bearing noise, and airflow volume — all within normal parameters.. Confirmed refrigerator and freezer cabinet temperatures were stabilizing toward set points and provided the customer with written documentation of service performed, parts inspected, and the recommended schedule for the next annual maintenance visit.',
    partsReplaced: [
