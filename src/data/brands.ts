...
export const brands: Brand[] = [
  ...
  },
  {
    slug: 'jenn-air',
    name: 'Jenn-Air',
    tagline: 'Built-In & Counter-Depth Specialists',
    intro: 'Expert Jenn-Air refrigerator repair in Houston, TX. Certified technicians, all models. Same-day service available. Call (346) 512-3688.',
    commonProblems: [
      'Refrigerator not cooling',
  ...
  },
  {
    slug: 'maytag',
    name: 'Maytag',
    tagline: 'Dependable Repair for Tough Maytag Units',
    intro: 'Expert Maytag refrigerator repair in Houston, TX. Certified technicians, all models. Same-day service available. Call (346) 512-3688.',
    commonProblems: [
      'Refrigerator not cooling',
      'Freezer not freezing',
      'Ice maker not working',
  ...
  },
  {
    slug: 'amana',
    name: 'Amana',
    tagline: 'Affordable Repair for Amana Refrigerators',
    intro: 'Expert Amana refrigerator repair in Houston, TX. Certified technicians, all models. Same-day service available. Call (346) 512-3688.',
    commonProblems: [
      'Refrigerator not cooling',
      'Freezer not freezing',
      'Ice maker not working',
  ...
  },
  {
    slug: 'frigidaire',
    name: 'Frigidaire',
    tagline: 'Fast Frigidaire Refrigerator Repair',
    intro: 'Expert Frigidaire refrigerator repair in Houston, TX. Certified technicians, all models. Same-day service available. Call (346) 512-3688.',
    commonProblems: [
      'Refrigerator not cooling',
      'Freezer not freezing',
      'Ice maker not working',
  ...
  },
  {
    slug: 'electrolux',
    name: 'Electrolux',
    tagline: 'European-Engineered Refrigerator Specialists',
    intro: 'Expert Electrolux refrigerator repair in Houston, TX. Certified technicians, all models. Same-day service available. Call (346) 512-3688.',
    commonProblems: [
      'Refrigerator not cooling',
      'Freezer not freezing',
      'Ice maker not working',
  ...
  },
  {
    slug: 'hisense',
    name: 'Hisense',
    tagline: 'Hisense Refrigerator Repair in Houston',
    intro: 'Expert Hisense refrigerator repair in Houston, TX. Certified technicians, all models. Same-day service available. Call (346) 512-3688.',
    commonProblems: [
      'Refrigerator not cooling',
      'Freezer not freezing',
      'Ice maker not working',
  ...
  },
  {
    slug: 'insignia',
    name: 'Insignia',
    tagline: 'Insignia Refrigerator & Freezer Repair',
    intro: 'Expert Insignia refrigerator repair in Houston, TX. Certified technicians, all models. Same-day service available. Call (346) 512-3688.',
    commonProblems: [
      'Refrigerator not cooling',
      'Freezer not freezing',
      'Ice maker not working',
  ...
  },
  {
    slug: 'zline',
    name: 'Zline',
    tagline: 'Italian-Designed Zline Refrigerator Repair',
    intro: 'Expert Zline refrigerator repair in Houston, TX. Certified technicians, all models. Same-day service available. Call (346) 512-3688.',
    commonProblems: [
      'Refrigerator not cooling',
      'Freezer not freezing',
      'Ice maker not working',
  ...
  },
  {
    slug: 'kenmore',
    name: 'Kenmore',
    tagline: 'Trusted Kenmore Refrigerator Repair',
    intro: 'Expert Kenmore refrigerator repair in Houston, TX. Certified technicians, all models. Same-day service available. Call (346) 512-3688.',
    commonProblems: [
      'Refrigerator not cooling',
      'Freezer not freezing',
      'Ice maker not working',
  ...
  },
  {
    slug: 'miele',
    name: 'Miele',
    tagline: 'Premium German Miele Refrigerator Repair',
    intro: 'Expert Miele refrigerator repair in Houston, TX. Certified technicians, all models. Same-day service available. Call (346) 512-3688.',
    commonProblems: [
      'Refrigerator not cooling',
      'Freezer not freezing',
      'Ice maker not working',
